...
public static class HealSkillsManager
{
    ...
    private static void ApplyHealEffect(SkillUseContext skillCtx, Unit target, double healAmount)
    {
        ...
        bool isReviveSkill = SkillConstants.REVIVE_ONLY_SKILLS.Contains(skillCtx.Skill.Name);
        bool isReviveAndHealSkill = SkillConstants.REVIVE_AND_HEAL_SKILLS.Contains(skillCtx.Skill.Name);
