...
public class ActionHandler : IActionHandler
{
        ...
        ICombatActionProcessor combatActionProcessor)
    {
        ...
        _combatActionProcessor = combatActionProcessor ?? throw new ArgumentNullException(nameof(combatActionProcessor));
    }
    ...
    private bool HandleSamuraiAction(Samurai samurai, string choice, Player currentPlayer)
    {
        ...
        return _combatActionProcessor.ProcessSamuraiAction(samurai, action, currentPlayer);
    }
    ...
    private bool HandleDemonAction(Demon demon, string choice, Player currentPlayer)
    {
        ...
        return _combatActionProcessor.ProcessDemonAction(demon, action, currentPlayer);
    }
}
