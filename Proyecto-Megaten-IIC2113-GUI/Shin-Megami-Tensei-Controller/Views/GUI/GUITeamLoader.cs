...
public class GUITeamLoader : ITeamLoader
{
    ...
    string player1Name = PlayerNameConstants.PlayerOneName;
    string player2Name = PlayerNameConstants.PlayerTwoName;
    ...
    public Dictionary<string, Player> CreatePlayersFromTeamInfo((PlayerTeamInfo Team1, PlayerTeamInfo Team2) teamInfos)
    {
        try
        {
            var player1 = CreatePlayerFromTeamInfo(teamInfos.Team1, player1Name);
            var player2 = CreatePlayerFromTeamInfo(teamInfos.Team2, player2Name);
    ...
    private Dictionary<string, Player> CreateInvalidTeams()
    {
        ...
        return new Dictionary<string, Player>
        {
            [player1Name] = CreatePlayerWithTeam(player1Name, invalidTeam),
            [player2Name] = CreatePlayerWithTeam(player2Name, invalidTeam)
        };
    }
